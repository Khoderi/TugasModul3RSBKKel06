...
<div class="container" >
	...
	<center><h1><b>Data Mahasiswa</b></h1>
            <p><b>Modul RSBK - Kelompok06</b></p>
        <h3>Selamat Datang, <%=session.getAttribute("userName")%></h3></center>
	...
	<div class="col-md-9 daftar">
            <form action="./StudentServlet" method="POST">
                ...
                <tr>
                <td colspan="2">
                <input type="submit" class="btn btn-primary btn-lg btn-block" name="action" value="Add" />
                <input type="submit" class="btn btn-success btn-lg btn-block" name="action" value="Edit" />
                <input type="submit" class="btn btn-danger btn-lg btn-block" name="action" value="Delete" />
                <input type="submit" class="btn btn-warning btn-lg btn-block" name="action" value="Search" />
                </td>
                </tr>
                </table>
            </form>
